...
import { createDataStore } from "../threat-intelligence/data_store";
...
export const Index = () => {
    ...
    return (
        <KibanaLayout
            pageHeader={{
                pageTitle: "Indicator match rule",
                
            }}
        >

            <EuiText>
                <h2>Indicator match rule setup</h2>
                <p>This is where you setup the indicator match rule</p>
                
                <EuiButton fill href="../threat-intelligence/indicators-found">Continue</EuiButton>
            </EuiText>
            <EuiSpacer size="l" />
